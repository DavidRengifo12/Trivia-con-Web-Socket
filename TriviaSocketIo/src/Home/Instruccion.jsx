  ...
  return (
    <>
      <section className="p-4 md:p-8 lg:p-20" id="instrucciones">
        <h1 className="flex justify-center text-center text-2xl text-purple-500 m-5">INSTRUCCIONES TRIVIAQUEST</h1>
        <div className="max-w-7xl mx-auto  bg-neutral-300">
          <div className="rounded-lg md:rounded-xl overflow-hidden shadow-2xl">
            <div className="bg-purple-500 p-6  flex items-center gap-4 md:gap-8">
            ...
            <div className="p-4 sm:p-6 md:p-10 text-sky-800 fondo-image-intruccion">
              <div className="bg-teal-400 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-6 p-4 rounded-xl shadow-lg ">
                <span className="bg-purple-500 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold text-sm shrink-0 mt-1 shadow-md">1</span>
              ...
              <div className="bg-teal-400 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-6 p-4 rounded-xl shadow-lg ">
                <span className="bg-purple-500 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold text-sm shrink-0 mt-1 shadow-md">2</span>
                <p className="m-0 text-white font-semibold text-sm sm:text-base">
              ...
              <div className="bg-teal-400 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-6 p-4 rounded-xl shadow-lg ">
                <span className="bg-purple-500 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold text-sm shrink-0 mt-1 shadow-md">3</span>
                <p className="m-0  text-white font-semibold text-sm sm:text-base">
